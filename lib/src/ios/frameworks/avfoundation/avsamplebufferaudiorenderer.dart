...
class AVSampleBufferAudioRenderer extends NSObject
    with AVQueuedSampleBufferRendering {
  AVSampleBufferAudioRenderer([Class isa])
      : super(isa ?? Class('AVSampleBufferAudioRenderer'));
  AVSampleBufferAudioRenderer.fromPointer(Pointer<Void> ptr)
  ...
  String get audioOutputDeviceUniqueID {
    Pointer<Void> result =
        perform(SEL('audioOutputDeviceUniqueID'), decodeRetVal: false);
    return NSString.fromPointer(result).raw;
  }

  @NativeAvailable(macos: '10.13')
  @NativeUnavailable(ios, tvos, watchos)
  set audioOutputDeviceUniqueID(String audioOutputDeviceUniqueID) =>
      perform(SEL('setAudioOutputDeviceUniqueID:'),
          args: [audioOutputDeviceUniqueID]);

  AVAudioTimePitchAlgorithm get audioTimePitchAlgorithm {
    Pointer<Void> result =
        perform(SEL('audioTimePitchAlgorithm'), decodeRetVal: false);
    return AVAudioTimePitchAlgorithm.fromPointer(result);
  }

  set audioTimePitchAlgorithm(
          AVAudioTimePitchAlgorithm audioTimePitchAlgorithm) =>
      perform(SEL('setAudioTimePitchAlgorithm:'),
          args: [audioTimePitchAlgorithm]);
}

extension AVSampleBufferAudioRendererAVSampleBufferAudioRendererVolumeControl
    on AVSampleBufferAudioRenderer {
  double get volume {
...
extension AVSampleBufferAudioRendererAVSampleBufferAudioRendererQueueManagement
    on AVSampleBufferAudioRenderer {
  void flushFromSourceTimeCompletionHandler(
      CMTime time, void completionHandler(BOOL flushSucceeded)) {
    perform(SEL('flushFromSourceTime:completionHandler:'),
        args: [time, completionHandler]);
  }
}
// You can uncomment this line when this package is ready.
