...
@native
class AVMetadataItem extends NSObject with AVAsynchronousKeyValueLoading,NSCopying,NSMutableCopying {
...
Pointer<Void> result = perform(SEL('identifier'), decodeRetVal: false);
  ...
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
  set identifier(AVMetadataIdentifier identifier) => perform(SEL('setIdentifier:'), args: [identifier]);
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
...
Pointer<Void> result = perform(SEL('duration'), decodeRetVal: false);
  ...
  @NativeAvailable(macos: '10.7', ios: '4.2', tvos: '9.0', watchos: '1.0')
  set duration(CMTime duration) => perform(SEL('setDuration:'), args: [duration]);
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
  String get dataType {
Pointer<Void> result = perform(SEL('dataType'), decodeRetVal: false);
  ...
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
  set dataType(String dataType) => perform(SEL('setDataType:'), args: [dataType]);
...
Pointer<Void> result = perform(SEL('extraAttributes'), decodeRetVal: false);
  ...
  set extraAttributes(id extraAttributes) => perform(SEL('setExtraAttributes:'), args: [extraAttributes]);
...
Pointer<Void> result = perform(SEL('stringValue'), decodeRetVal: false);
  ...
  set stringValue(String stringValue) => perform(SEL('setStringValue:'), args: [stringValue]);
...
Pointer<Void> result = perform(SEL('numberValue'), decodeRetVal: false);
  ...
  set numberValue(NSNumber numberValue) => perform(SEL('setNumberValue:'), args: [numberValue]);
...
Pointer<Void> result = perform(SEL('dateValue'), decodeRetVal: false);
  ...
  set dateValue(NSDate dateValue) => perform(SEL('setDateValue:'), args: [dateValue]);
...
Pointer<Void> result = perform(SEL('dataValue'), decodeRetVal: false);
  ...
  set dataValue(NSData dataValue) => perform(SEL('setDataValue:'), args: [dataValue]);
...
extension AVMetadataItemAVAsynchronousKeyValueLoading on AVMetadataItem {
  ...
  AVKeyValueStatus statusOfValueForKeyError(String key, {NSObjectRef<NSError> outError}) {
    Pointer<Void> result = perform(SEL('statusOfValueForKey:error:'), args: [key,outError], decodeRetVal: false);
    return AVKeyValueStatus.fromPointer(result);
  }
  @NativeAvailable(macos: '10.7', ios: '4.2', tvos: '9.0', watchos: '1.0')
  void loadValuesAsynchronouslyForKeysCompletionHandler(String keys, {void handler()}) {
     perform(SEL('loadValuesAsynchronouslyForKeys:completionHandler:'), args: [keys,handler]);
  }
...
extension AVMetadataItemAVMetadataItemArrayFiltering on AVMetadataItem {
  ...
  static AVMetadataItem metadataItemsFromArrayFilteredAndSortedAccordingToPreferredLanguages(AVMetadataItem metadataItems, String preferredLanguages) {
    Pointer<Void> result = Class('AVMetadataItemArrayFiltering').perform(SEL('metadataItemsFromArray:filteredAndSortedAccordingToPreferredLanguages:'), args: [metadataItems,preferredLanguages], decodeRetVal: false);
    return AVMetadataItem.fromPointer(result);
  }
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
  static AVMetadataItem metadataItemsFromArrayFilteredByIdentifier(AVMetadataItem metadataItems, AVMetadataIdentifier identifier) {
    Pointer<Void> result = Class('AVMetadataItemArrayFiltering').perform(SEL('metadataItemsFromArray:filteredByIdentifier:'), args: [metadataItems,identifier], decodeRetVal: false);
    return AVMetadataItem.fromPointer(result);
  }
  @NativeAvailable(macos: '10.9', ios: '7.0', tvos: '9.0', watchos: '1.0')
  static AVMetadataItem metadataItemsFromArrayFilteredByMetadataItemFilter(AVMetadataItem metadataItems, AVMetadataItemFilter metadataItemFilter) {
    Pointer<Void> result = Class('AVMetadataItemArrayFiltering').perform(SEL('metadataItemsFromArray:filteredByMetadataItemFilter:'), args: [metadataItems,metadataItemFilter], decodeRetVal: false);
    return AVMetadataItem.fromPointer(result);
  }
...
Pointer<Void> result = perform(SEL('commonKey'), decodeRetVal: false);
  ...
  set commonKey(AVMetadataKey commonKey) => perform(SEL('setCommonKey:'), args: [commonKey]);
...
Pointer<Void> result = perform(SEL('keySpace'), decodeRetVal: false);
  ...
  set keySpace(AVMetadataKeySpace keySpace) => perform(SEL('setKeySpace:'), args: [keySpace]);
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
  static AVMetadataIdentifier identifierForKeyKeySpace(NSObject key, AVMetadataKeySpace keySpace) {
    Pointer<Void> result = Class('AVMetadataItemKeyAndKeyspace').perform(SEL('identifierForKey:keySpace:'), args: [key,keySpace], decodeRetVal: false);
    return AVMetadataIdentifier.fromPointer(result);
  }
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
  static AVMetadataKeySpace keySpaceForIdentifier(AVMetadataIdentifier identifier) {
    Pointer<Void> result = Class('AVMetadataItemKeyAndKeyspace').perform(SEL('keySpaceForIdentifier:'), args: [identifier], decodeRetVal: false);
    return AVMetadataKeySpace.fromPointer(result);
  }
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '9.0', watchos: '1.0')
  static NSObject keyForIdentifier(AVMetadataIdentifier identifier) {
    Pointer<Void> result = Class('AVMetadataItemKeyAndKeyspace').perform(SEL('keyForIdentifier:'), args: [identifier], decodeRetVal: false);
...
class AVMutableMetadataItem extends AVMetadataItem {
  AVMutableMetadataItem([Class isa]) : super(isa ?? Class('AVMutableMetadataItem'));
...
Pointer<Void> result = perform(SEL('extraAttributes'), decodeRetVal: false);
  ...
  static AVMutableMetadataItem metadataItem() {
    Pointer<Void> result = Class('AVMutableMetadataItem').perform(SEL('metadataItem'), decodeRetVal: false);
    return AVMutableMetadataItem.fromPointer(result);
  }

}

extension AVMutableMetadataItemAVMutableMetadataItemDateRepresentation on AVMutableMetadataItem {
  @NativeAvailable(macos: '10.11', ios: '9.0', tvos: '9.0', watchos: '2.0')
  NSDate get startDate {
Pointer<Void> result = perform(SEL('startDate'), decodeRetVal: false);
    return NSDate.fromPointer(result);
...
extension AVMutableMetadataItemAVMutableMetadataItemKeyAndKeyspace on AVMutableMetadataItem {
...
extension AVMetadataItemAVMetadataItemLazyValueLoading on AVMetadataItem {
  @NativeAvailable(macos: '10.11', ios: '9.0', tvos: '9.0', watchos: '2.0')
  static AVMetadataItem metadataItemWithPropertiesOfMetadataItemValueLoadingHandler(AVMetadataItem metadataItem, void handler(AVMetadataItemValueRequest valueRequest)) {
    Pointer<Void> result = Class('AVMetadataItemLazyValueLoading').perform(SEL('metadataItemWithPropertiesOfMetadataItem:valueLoadingHandler:'), args: [metadataItem,handler], decodeRetVal: false);
    return AVMetadataItem.fromPointer(result);
  }
...
class AVMetadataItemValueRequest extends NSObject {
  AVMetadataItemValueRequest([Class isa]) : super(isa ?? Class('AVMetadataItemValueRequest'));
  AVMetadataItemValueRequest.fromPointer(Pointer<Void> ptr) : super.fromPointer(ptr);
...
Pointer<Void> result = perform(SEL('metadataItem'), decodeRetVal: false);
  ...
  set metadataItem(AVMetadataItem metadataItem) => perform(SEL('setMetadataItem:'), args: [metadataItem]);
...
class AVMetadataItemFilter extends NSObject {
  AVMetadataItemFilter([Class isa]) : super(isa ?? Class('AVMetadataItemFilter'));
  ...
  static AVMetadataItemFilter metadataItemFilterForSharing() {
    Pointer<Void> result = Class('AVMetadataItemFilter').perform(SEL('metadataItemFilterForSharing'), decodeRetVal: false);
    return AVMetadataItemFilter.fromPointer(result);
  }

}

extension AVMetadataItemAVMetadataItemArrayFilteringDeprecable on AVMetadataItem {
  
  static AVMetadataItem metadataItemsFromArrayWithLocale(AVMetadataItem metadataItems, NSLocale locale) {
    Pointer<Void> result = Class('AVMetadataItemArrayFilteringDeprecable').perform(SEL('metadataItemsFromArray:withLocale:'), args: [metadataItems,locale], decodeRetVal: false);
    return AVMetadataItem.fromPointer(result);
  }
  
  static AVMetadataItem metadataItemsFromArrayWithKeyKeySpace(AVMetadataItem metadataItems, {NSObject key, AVMetadataKeySpace keySpace}) {
    Pointer<Void> result = Class('AVMetadataItemArrayFilteringDeprecable').perform(SEL('metadataItemsFromArray:withKey:keySpace:'), args: [metadataItems,key,keySpace], decodeRetVal: false);
    return AVMetadataItem.fromPointer(result);
  }
