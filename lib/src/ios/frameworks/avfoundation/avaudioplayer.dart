...
return perform(SEL('numberOfChannels'));
  ...
  set numberOfChannels(NSUInteger numberOfChannels) => perform(SEL('setNumberOfChannels:'), args: [numberOfChannels]);
...
Pointer<Void> result = perform(SEL('duration'), decodeRetVal: false);
  ...
  @NativeAvailable(macos: '10.13') @NativeUnavailable(ios, watchos, tvos)
...
Pointer<Void> result = perform(SEL('currentDevice'), decodeRetVal: false);
  ...
  @NativeAvailable(macos: '10.13') @NativeUnavailable(ios, watchos, tvos)
  set currentDevice(String currentDevice) => perform(SEL('setCurrentDevice:'), args: [currentDevice]);
...
Pointer<Void> result = perform(SEL('delegate'), decodeRetVal: false);
  ...
  set delegate(AVAudioPlayerDelegate delegate) => perform(SEL('setDelegate:'), args: [delegate]);
...
return perform(SEL('enableRate'));
  ...
  @NativeAvailable(macos: '10.8', ios: '5.0', watchos: '2.0', tvos: '9.0')
  set enableRate(bool enableRate) => perform(SEL('setEnableRate:'), args: [enableRate]);
  @NativeAvailable(macos: '10.8', ios: '5.0', watchos: '2.0', tvos: '9.0')
  double get rate {
...
Pointer<Void> result = perform(SEL('currentTime'), decodeRetVal: false);
  ...
  set currentTime(NSTimeInterval currentTime) => perform(SEL('setCurrentTime:'), args: [currentTime]);
  @NativeAvailable(macos: '10.7', ios: '4.0', watchos: '2.0', tvos: '9.0')
  NSTimeInterval get deviceCurrentTime {
Pointer<Void> result = perform(SEL('deviceCurrentTime'), decodeRetVal: false);
    return NSTimeInterval.fromPointer(result);

}
  @NativeAvailable(macos: '10.7', ios: '4.0', watchos: '2.0', tvos: '9.0')
  set deviceCurrentTime(NSTimeInterval deviceCurrentTime) => perform(SEL('setDeviceCurrentTime:'), args: [deviceCurrentTime]);
...
return perform(SEL('numberOfLoops'));
  ...
  set numberOfLoops(NSInteger numberOfLoops) => perform(SEL('setNumberOfLoops:'), args: [numberOfLoops]);
  @NativeAvailable(macos: '10.7', ios: '4.0', watchos: '2.0', tvos: '9.0')
  id get settings {
...
return perform(SEL('meteringEnabled'));
  ...
  set meteringEnabled(bool meteringEnabled) => perform(SEL('setMeteringEnabled:'), args: [meteringEnabled]);
...
Pointer<Void> result = perform(SEL('channelAssignments'), decodeRetVal: false);
    return AVAudioSessionChannelDescription.fromPointer(result);

}
  @NativeAvailable(ios: '7.0', watchos: '2.0', tvos: '9.0') @NativeUnavailable(macos)
  set channelAssignments(AVAudioSessionChannelDescription channelAssignments) => perform(SEL('setChannelAssignments:'), args: [channelAssignments]);
  AVAudioPlayer.initWithContentsOfURLError(NSURL url, NSObjectRef<NSError> outError)
     : super.fromPointer(_initWithContentsOfURLError(url,outError));

  static Pointer<Void> _initWithContentsOfURLError(NSURL url, NSObjectRef<NSError> outError) {
  ...
  static Pointer<Void> _initWithDataError(NSData data, NSObjectRef<NSError> outError) {
    Pointer<Void> target = alloc(Class('AVAudioPlayer'));
    SEL sel = SEL('initWithData:error:');
    return msgSend(target, sel, args: [data,outError], decodeRetVal: false);
  }

  AVAudioPlayer.initWithContentsOfURLFileTypeHintError(NSURL url, NSObjectRef<NSError> outError, {String utiString})
     : super.fromPointer(_initWithContentsOfURLFileTypeHintError(url,utiString,outError));

  static Pointer<Void> _initWithContentsOfURLFileTypeHintError(NSURL url, NSObjectRef<NSError> outError, {String utiString}) {
    Pointer<Void> target = alloc(Class('AVAudioPlayer'));
    SEL sel = SEL('initWithContentsOfURL:fileTypeHint:error:');
    return msgSend(target, sel, args: [url,utiString,outError], decodeRetVal: false);
  }

  AVAudioPlayer.initWithDataFileTypeHintError(NSData data, NSObjectRef<NSError> outError, {String utiString})
     : super.fromPointer(_initWithDataFileTypeHintError(data,utiString,outError));

  static Pointer<Void> _initWithDataFileTypeHintError(NSData data, NSObjectRef<NSError> outError, {String utiString}) {
    Pointer<Void> target = alloc(Class('AVAudioPlayer'));
    SEL sel = SEL('initWithData:fileTypeHint:error:');
    return msgSend(target, sel, args: [data,utiString,outError], decodeRetVal: false);
  }
...
abstract class AVAudioPlayerDelegate {
  registerAVAudioPlayerDelegate() {
    registerProtocolCallback(this, audioPlayerDidFinishPlayingSuccessfully, 'audioPlayerDidFinishPlaying:successfully:', AVAudioPlayerDelegate);
    registerProtocolCallback(this, audioPlayerDecodeErrorDidOccurError, 'audioPlayerDecodeErrorDidOccur:error:', AVAudioPlayerDelegate);
    registerProtocolCallback(this, audioPlayerBeginInterruption, 'audioPlayerBeginInterruption:', AVAudioPlayerDelegate);
    registerProtocolCallback(this, audioPlayerEndInterruptionWithOptions, 'audioPlayerEndInterruption:withOptions:', AVAudioPlayerDelegate);
    registerProtocolCallback(this, audioPlayerEndInterruptionWithFlags, 'audioPlayerEndInterruption:withFlags:', AVAudioPlayerDelegate);
    registerProtocolCallback(this, audioPlayerEndInterruption, 'audioPlayerEndInterruption:', AVAudioPlayerDelegate);
  }
  ...
  void audioPlayerEndInterruptionWithOptions(AVAudioPlayer player, NSUInteger flags);  
  void audioPlayerEndInterruptionWithFlags(AVAudioPlayer player, NSUInteger flags);  
