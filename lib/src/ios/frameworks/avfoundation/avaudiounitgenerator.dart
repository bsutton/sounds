...
@native
class AVAudioUnitGenerator extends AVAudioUnit with AVAudioMixing {
  AVAudioUnitGenerator([Class isa]) : super(isa ?? Class('AVAudioUnitGenerator'));
  AVAudioUnitGenerator.fromPointer(Pointer<Void> ptr) : super.fromPointer(ptr);
...
return perform(SEL('bypass'));
  ...
  static Pointer<Void> _initWithAudioComponentDescription(AudioComponentDescription audioComponentDescription) {
    Pointer<Void> target = alloc(Class('AVAudioUnitGenerator'));
