...
class AVCaptureVideoPreviewLayer extends CALayer {
  AVCaptureVideoPreviewLayer([Class isa])
      : super(isa ?? Class('AVCaptureVideoPreviewLayer'));
  AVCaptureVideoPreviewLayer.fromPointer(Pointer<Void> ptr)
  ...
  set session(AVCaptureSession session) =>
      perform(SEL('setSession:'), args: [session]);
  ...
  @NativeAvailable(ios: '6.0')
  set connection(AVCaptureConnection connection) =>
      perform(SEL('setConnection:'), args: [connection]);
  ...
  @NativeAvailable(ios: '13.0')
  @NativeUnavailable(macos)
  @NativeUnavailable(tvos, watchos)
  bool get previewing {
  ...
  @NativeUnavailable(macos)
  @NativeUnavailable(tvos, watchos)
  set previewing(bool previewing) =>
      perform(SEL('setPreviewing:'), args: [previewing]);
  @NativeDeprecated(
      "Use AVCaptureConnection's isVideoOrientationSupported instead.",
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  ...
  @NativeDeprecated(
      ...
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  set orientationSupported(bool orientationSupported) =>
      perform(SEL('setOrientationSupported:'), args: [orientationSupported]);
  @NativeDeprecated("Use AVCaptureConnection's videoOrientation instead.",
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  ...
  @NativeDeprecated("Use AVCaptureConnection's videoOrientation instead.",
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  set orientation(AVCaptureVideoOrientation orientation) =>
      perform(SEL('setOrientation:'), args: [orientation]);
  @NativeDeprecated(
  ...
  @NativeDeprecated(
      ...
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  set mirroringSupported(bool mirroringSupported) =>
      perform(SEL('setMirroringSupported:'), args: [mirroringSupported]);
  @NativeDeprecated(
      "Use AVCaptureConnection's automaticallyAdjustsVideoMirroring instead.",
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  ...
  @NativeDeprecated(
      ...
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  set automaticallyAdjustsMirroring(bool automaticallyAdjustsMirroring) =>
      perform(SEL('setAutomaticallyAdjustsMirroring:'),
          args: [automaticallyAdjustsMirroring]);
  @NativeDeprecated("Use AVCaptureConnection's videoMirrored instead.",
      ios: ['4.0', '6.0'])
  @NativeUnavailable(macos)
  bool get mirrored {
  ...
  static AVCaptureVideoPreviewLayer layerWithSession(AVCaptureSession session) {
    Pointer<Void> result = Class('AVCaptureVideoPreviewLayer').perform(
        SEL('layerWithSession:'),
        args: [session],
        decodeRetVal: false);
  ...
  static AVCaptureVideoPreviewLayer layerWithSessionWithNoConnection(
      AVCaptureSession session) {
    Pointer<Void> result = Class('AVCaptureVideoPreviewLayer').perform(
        SEL('layerWithSessionWithNoConnection:'),
        args: [session],
        decodeRetVal: false);
    return AVCaptureVideoPreviewLayer.fromPointer(result);
  }
  ...
  static Pointer<Void> _initWithSessionWithNoConnection(
      AVCaptureSession session) {
    Pointer<Void> target = alloc(Class('AVCaptureVideoPreviewLayer'));
  ...
  CGPoint captureDevicePointOfInterestForPoint(CGPoint pointInLayer) {
    Pointer<Void> result = perform(SEL('captureDevicePointOfInterestForPoint:'),
        args: [pointInLayer], decodeRetVal: false);
    return CGPoint.fromPointer(result);
  }

  @NativeAvailable(macos: '10.15', ios: '6.0')
  CGPoint pointForCaptureDevicePointOfInterest(
      CGPoint captureDevicePointOfInterest) {
    Pointer<Void> result = perform(SEL('pointForCaptureDevicePointOfInterest:'),
        args: [captureDevicePointOfInterest], decodeRetVal: false);
    return CGPoint.fromPointer(result);
  }

  @NativeAvailable(macos: '10.15', ios: '7.0')
  CGRect metadataOutputRectOfInterestForRect(CGRect rectInLayerCoordinates) {
    Pointer<Void> result = perform(SEL('metadataOutputRectOfInterestForRect:'),
        args: [rectInLayerCoordinates], decodeRetVal: false);
    return CGRect.fromPointer(result);
  }

  @NativeAvailable(macos: '10.15', ios: '7.0')
  CGRect rectForMetadataOutputRectOfInterest(
      CGRect rectInMetadataOutputCoordinates) {
    Pointer<Void> result = perform(SEL('rectForMetadataOutputRectOfInterest:'),
        args: [rectInMetadataOutputCoordinates], decodeRetVal: false);
    return CGRect.fromPointer(result);
  }

  @NativeAvailable(macos: '10.15', ios: '6.0')
  AVMetadataObject transformedMetadataObjectForMetadataObject(
      AVMetadataObject metadataObject) {
    Pointer<Void> result = perform(
        SEL('transformedMetadataObjectForMetadataObject:'),
        args: [metadataObject],
        decodeRetVal: false);
