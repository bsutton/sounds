...
@NativeAvailable(macos: '10.8', ios: '8.0', tvos: '10.2')
@NativeUnavailable(watchos)
@native
class AVSampleBufferDisplayLayer extends CALayer {
  AVSampleBufferDisplayLayer([Class isa])
      : super(isa ?? Class('AVSampleBufferDisplayLayer'));
  AVSampleBufferDisplayLayer.fromPointer(Pointer<Void> ptr)
...
extension AVSampleBufferDisplayLayerAVSampleBufferDisplayLayerQueueManagement
    on AVSampleBufferDisplayLayer {
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '10.2')
  @NativeUnavailable(watchos)
  ...
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '10.2')
  @NativeUnavailable(watchos)
  set status(AVQueuedSampleBufferRenderingStatus status) =>
      perform(SEL('setStatus:'), args: [status]);
  @NativeAvailable(macos: '10.10', ios: '8.0', tvos: '10.2')
  @NativeUnavailable(watchos)
  NSError get error {
  ...
  @NativeAvailable(macos: '11.0', ios: '14.0', tvos: '14.0')
  @NativeUnavailable(watchos)
  ...
  @NativeAvailable(macos: '11.0', ios: '14.0', tvos: '14.0')
  @NativeUnavailable(watchos)
  set requiresFlushToResumeDecoding(bool requiresFlushToResumeDecoding) =>
      perform(SEL('setRequiresFlushToResumeDecoding:'),
          args: [requiresFlushToResumeDecoding]);
  ...
  void requestMediaDataWhenReadyOnQueueUsingBlock(
    ...
    perform(SEL('requestMediaDataWhenReadyOnQueue:usingBlock:'),
        args: [queue, block]);
  }
...
extension AVSampleBufferDisplayLayerAVSampleBufferDisplayLayerImageProtection
    on AVSampleBufferDisplayLayer {
  ...
  @NativeAvailable(macos: '10.15', ios: '13.0', tvos: '13.0')
  @NativeUnavailable(watchos)
  set preventsCapture(bool preventsCapture) =>
      perform(SEL('setPreventsCapture:'), args: [preventsCapture]);
}

extension AVSampleBufferDisplayLayerAVSampleBufferDisplayLayerVideoDisplaySleepPrevention
    on AVSampleBufferDisplayLayer {
  @NativeAvailable(macos: '10.15', ios: '13.0', tvos: '13.0')
  @NativeUnavailable(watchos)
  ...
  @NativeAvailable(macos: '10.15', ios: '13.0', tvos: '13.0')
  @NativeUnavailable(watchos)
  set preventsDisplaySleepDuringVideoPlayback(
          bool preventsDisplaySleepDuringVideoPlayback) =>
      perform(SEL('setPreventsDisplaySleepDuringVideoPlayback:'),
          args: [preventsDisplaySleepDuringVideoPlayback]);
}
// You can uncomment this line when this package is ready.
