...
public class SoundsPlatformApi {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class OnPlaybackStopped {
    private SoundPlayerProxy player;
    public SoundPlayerProxy getPlayer() { return player; }
    public void setPlayer(SoundPlayerProxy setterArg) { this.player = setterArg; }
    ...
    static OnPlaybackStopped fromMap(HashMap map) {
      OnPlaybackStopped fromMapResult = new OnPlaybackStopped();
      Object player = map.get("player");
      fromMapResult.player = SoundPlayerProxy.fromMap((HashMap)player);
      Object track = map.get("track");
      fromMapResult.track = TrackProxy.fromMap((HashMap)track);
  ...
  public interface SoundsToPlatformApi {
    void initializePlayer(InitializePlayer arg,Result<Response> result);
    void initializePlayerWithShade(InitializePlayerWithShade arg,Result<Response> result);
    void releasePlayer(SoundPlayerProxy arg,Result<Response> result);
    void startPlayer(StartPlayer arg,Result<Response> result);
    void stopPlayer(SoundPlayerProxy arg,Result<Response> result);
    void pausePlayer(SoundPlayerProxy arg,Result<Response> result);
    void resumePlayer(SoundPlayerProxy arg,Result<Response> result);
    void seekToPlayer(SeekToPlayer arg,Result<Response> result);
    void getDuration(GetDuration arg,Result<DurationResponse> result);
    void setVolume(SetVolume arg,Result<Response> result);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.initializePlayer(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.initializePlayerWithShade(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.releasePlayer(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.startPlayer(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundPlayerProxy input = SoundPlayerProxy.fromMap((HashMap)message);
              api.stopPlayer(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundPlayerProxy input = SoundPlayerProxy.fromMap((HashMap)message);
              api.pausePlayer(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundPlayerProxy input = SoundPlayerProxy.fromMap((HashMap)message);
              api.resumePlayer(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.seekToPlayer(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.getDuration(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.setVolume(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.setPlaybackProgressInterval(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.requestAudioFocus(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundPlayerProxy input = SoundPlayerProxy.fromMap((HashMap)message);
              api.releaseAudioFocus(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              api.isShadeSupported(result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              api.isShadePauseSupported(result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              api.isShadeSkipForwardSupported(result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              api.isShadeSkipBackwardsSupported(result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              api.isBackgroundPlaybackSupported(result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.initializeRecorder(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundRecorderProxy input = SoundRecorderProxy.fromMap((HashMap)message);
              api.releaseRecorder(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.startRecording(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundRecorderProxy input = SoundRecorderProxy.fromMap((HashMap)message);
              api.stopRecording(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundRecorderProxy input = SoundRecorderProxy.fromMap((HashMap)message);
              api.pauseRecording(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              SoundRecorderProxy input = SoundRecorderProxy.fromMap((HashMap)message);
              api.resumeRecording(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.setRecordingProgressInterval(input,result -> {wrapped.put("result", result.toMap());reply.reply(wrapped);});
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
  ...
  public static class SoundsFromPlatformApi {
    ...
    public void onPlaybackStopped(OnPlaybackStopped argInput, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.SoundsFromPlatformApi.onPlaybackStopped", new StandardMessageCodec());
      HashMap inputMap = argInput.toMap();
      channel.send(inputMap, channelReply -> {
        callback.reply(null);
      });
