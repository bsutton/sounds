...
-(NSDictionary*)toMap;
@end
@interface FLTOnPlaybackStopped ()
+(FLTOnPlaybackStopped*)fromMap:(NSDictionary*)dict;
-(NSDictionary*)toMap;
@end
...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.uuid ? self.uuid : [NSNull null]), @"uuid", (self.path ? self.path : [NSNull null]), @"path", (self.mediaFormat ? [self.mediaFormat toMap] : [NSNull null]), @"mediaFormat", nil];
}
@end
...
@implementation FLTOnPlaybackStopped
+(FLTOnPlaybackStopped*)fromMap:(NSDictionary*)dict {
  FLTOnPlaybackStopped* result = [[FLTOnPlaybackStopped alloc] init];
  result.player = [FLTSoundPlayerProxy fromMap:dict[@"player"]];
  if ((NSNull *)result.player == [NSNull null]) {
    result.player = nil;
  }
...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.player ? [self.player toMap] : [NSNull null]), @"player", (self.track ? [self.track toMap] : [NSNull null]), @"track", (self.errorCode ? self.errorCode : [NSNull null]), @"errorCode", (self.error ? self.error : [NSNull null]), @"error", nil];
}
@end
...
void FLTSoundsToPlatformApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<FLTSoundsToPlatformApi> api) {
  ...
  }
  {
    ...
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTResponse *output = [api isShadeSupported:&error];
        callback(wrapResult([output toMap], error));
      }];
    }
    else {
  ...
  }
  {
    ...
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTResponse *output = [api isShadePauseSupported:&error];
        callback(wrapResult([output toMap], error));
      }];
    }
    else {
  ...
  }
  {
    ...
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTResponse *output = [api isShadeSkipForwardSupported:&error];
        callback(wrapResult([output toMap], error));
      }];
    }
    else {
  ...
  }
  {
    ...
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTResponse *output = [api isShadeSkipBackwardsSupported:&error];
        callback(wrapResult([output toMap], error));
      }];
    }
    else {
  ...
  }
  {
    ...
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTResponse *output = [api isBackgroundPlaybackSupported:&error];
        callback(wrapResult([output toMap], error));
      }];
    }
    else {
...
- (void)onPlaybackStopped:(FLTOnPlaybackStopped*)input completion:(void(^)(NSError* _Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.SoundsFromPlatformApi.onPlaybackStopped"
      binaryMessenger:self.binaryMessenger];
  NSDictionary* inputMap = [input toMap];
  [channel sendMessage:inputMap reply:^(id reply) {
    completion(nil);
