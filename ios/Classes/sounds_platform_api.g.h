...
@property(nonatomic, copy, nullable) NSString * albumArtUrl;
@property(nonatomic, copy, nullable) NSString * albumArtAsset;
@property(nonatomic, copy, nullable) NSString * albumArtFile;
@end
...
@interface FLTBoolResponse : NSObject
@property(nonatomic, strong, nullable) NSNumber * success;
@property(nonatomic, strong, nullable) NSNumber * errorCode;
@property(nonatomic, copy, nullable) NSString * error;
@property(nonatomic, strong, nullable) NSNumber * boolResult;
@end
...
@interface FLTOnPlaybackFinished : NSObject
@property(nonatomic, strong, nullable) FLTSoundPlayerProxy * player;
@property(nonatomic, strong, nullable) FLTTrackProxy * track;
@end
...
@interface FLTOnShadePaused : NSObject
@property(nonatomic, strong, nullable) FLTSoundPlayerProxy * player;
@property(nonatomic, strong, nullable) FLTTrackProxy * track;
@end
...
-(nullable FLTBoolResponse *)isShadeSupported:(FlutterError *_Nullable *_Nonnull)error;
-(nullable FLTBoolResponse *)isShadePauseSupported:(FlutterError *_Nullable *_Nonnull)error;
-(nullable FLTBoolResponse *)isShadeSkipForwardSupported:(FlutterError *_Nullable *_Nonnull)error;
-(nullable FLTBoolResponse *)isShadeSkipBackwardsSupported:(FlutterError *_Nullable *_Nonnull)error;
-(nullable FLTBoolResponse *)isBackgroundPlaybackSupported:(FlutterError *_Nullable *_Nonnull)error;
